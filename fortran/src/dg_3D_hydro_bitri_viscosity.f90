...
!-------------------------------------------------------------------------------------------------------------------------------------------                                        
	...
	real, parameter :: aindm1 = aindex - 1.0, cp = aindex/(aindex - 1.0), clt = 2., vis = 1.e-2, epsi = 5., amplv = 0.0, amplm = 0.0, amplen = 10.
	...
	real, parameter :: T_floor = 0.026/te0, rh_floor = 1.e-1, P_floor = T_floor*rh_floor, rh_mult = 1.01, rh_min = rh_mult*(1. - P_base/P_1)**(1./7.2)
...
!------------------------------------------------------------------------------- 
       ...
       subroutine prep_advance(Q_ri)
	    ...
	    real, dimension(nx,ny,nz,nQ,nbasis) :: Q_ri
	        ...
	        if(ieos .eq. 1)call limiter(Q_ri)
	        if(ieos .eq. 2)call limiter2(Q_ri)
