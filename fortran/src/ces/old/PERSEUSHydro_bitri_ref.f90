...
!                              Temperature         te0
!
! Note: this is a reference code used to compare changes made to experimental
!       code versions. It should be equivalent to dg_3D_hydro_bitri_viscosity.f90
!       except for the modified indentation.
!-------------------------------------------------------------------------------------------------------------------------------------------
